...
AutoChargeStationNoMob::AutoChargeStationNoMob( Drivetrain *drivetrain, Arm *arm, Camera *camera, Claw *claw, Pouch *pouch ) 
{
    AddCommands
    (

	  CmdPrintText("Auto AutoChargeStationNoMob"),
      //Initial Setup
