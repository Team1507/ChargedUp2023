...
AutoScoreLink::AutoScoreLink(Drivetrain *drivetrain, Arm *arm, Claw *claw, Camera *camera, Pouch *pouch) 
{
AddCommands
    (
      //Initial Setup
    ...
    // Score Cone
      ...
      CmdPouchIntakeRetract(pouch),
      CmdPouchIntakeSetPower(pouch, Pouch::WhatIntake::Inner, 0.0),
      CmdDriveStraightGyro(drivetrain, .3, 103, 90, 229, false, false, 0.0),
      CmdDriveToAprilTag(drivetrain, camera, .3),
      GrpScoringSetPosition(arm, claw, pouch, ScoringPosition::HighRight),
      frc2::WaitCommand(0.5_s),
      CmdClawEject(claw),
      GrpScoringSetPosition(arm, claw, pouch, ScoringPosition::Home)
